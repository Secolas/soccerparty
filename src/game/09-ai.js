    // ================= AI OPPONENT =================
    // When the CPU holds two conflicting shot styles (e.g. Brazil: Curveball + Serpent),
    // pick per flick: Curveball to bend around a defender blocking the lane, else Serpent.
