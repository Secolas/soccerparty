    ...
    function aiComputeShot(){
      ...
      var _s3=false; try{ _s3=(typeof stadiumHazards==='function')&&stadiumHazards()&&(boardKey==='tennis'||boardKey==='court'||boardKey==='baseball'||boardKey==='minigolf'||boardKey==='gridiron');
      }catch(e){}
      if(_s3){ spread*=0.55; }
