    ...
    function drawSkateTracks(ctx,now){ if(typeof skateTracks!=='function') return; var trk=skateTracks(); for(var i=0;i<trk.length;i++){ var t=trk[i]; ctx.save(); ctx.strokeStyle='rgba(255,140,60,0.28)'; ctx.lineWidth=12; ctx.lineCap='round'; ctx.beginPath(); ctx.arc(t.cx,t.cy,t.R,t.a0,t.a1); ctx.stroke(); ctx.strokeStyle='rgba(255,210,120,0.9)'; ctx.lineWidth=3; ctx.beginPath(); ctx.arc(t.cx,t.cy,t.R,t.a0,t.a1); ctx.stroke(); ctx.strokeStyle='rgba(90,60,25,0.55)'; ctx.setLineDash([4,6]); ctx.lineDashOffset=-((now||0)*0.03); ctx.lineWidth=1.5; ctx.beginPath(); ctx.arc(t.cx,t.cy,t.R,t.a0,t.a1); ctx.stroke(); ctx.setLineDash([]); ctx.restore(); } var _st=(typeof hzTier==='function')?hzTier():0; if(_st>=1){ ctx.save(); var bw=26; var lg=ctx.createLinearGradient(WALL,0,WALL+bw,0); lg.addColorStop(0,'rgba(120,200,255,0.22)'); lg.addColorStop(1,'rgba(120,200,255,0)'); ctx.fillStyle=lg; ctx.fillRect(WALL,WALL,bw,H-WALL*2); var rg=ctx.createLinearGradient(W-WALL,0,W-WALL-bw,0); rg.addColorStop(0,'rgba(120,200,255,0.22)'); rg.addColorStop(1,'rgba(120,200,255,0)'); ctx.fillStyle=rg; ctx.fillRect(W-WALL-bw,WALL,bw,H-WALL*2); ctx.restore(); } if(_st>=2&&typeof skateBumps==='function'){ var bm=skateBumps(); for(var b=0;b<bm.length;b++){ var p=bm[b]; ctx.save(); ctx.translate(p.x,p.y); var R=p.r+2; ctx.strokeStyle='rgba(0,0,0,0.20)'; ctx.lineWidth=2; ctx.beginPath(); ctx.ellipse(0,0,R,R*0.7,0,0,6.283); ctx.stroke(); ctx.strokeStyle='rgba(255,255,255,0.10)'; ctx.lineWidth=1; ctx.beginPath(); ctx.ellipse(0,-0.8,R,R*0.7,0,0,6.283); ctx.stroke(); var g=ctx.createRadialGradient(-R*0.34,-R*0.42,1,0,0,R*1.2); g.addColorStop(0,'rgba(255,255,255,0.22)'); g.addColorStop(0.5,'rgba(255,255,255,0.04)'); g.addColorStop(1,'rgba(0,0,0,0.20)'); ctx.fillStyle=g; ctx.beginPath(); ctx.ellipse(0,0,R,R*0.72,0,0,6.283); ctx.fill(); ctx.fillStyle='rgba(255,255,255,0.26)'; ctx.beginPath(); ctx.ellipse(-R*0.32,-R*0.36,R*0.22,R*0.13,0,0,6.283); ctx.fill(); ctx.restore(); } } }
