    ...
    /* AFTERSHOCK: the shot carries a charge — the first opponent piece it strikes is SHOCKED until the
       end of the shooter's NEXT flick (aftStun tracks pending -> active -> gone; see trioReset). One shock
       per flick (aftUsed), and the ball still bounces off whatever it shocked, so turns always end.
