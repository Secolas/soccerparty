...
const ASSETS = [
  ...
  { file: "roymap2.png",           size: 512, keyOut: false, prompt: `A beautiful hand-illustrated fantasy ADVENTURE MAP, richly detailed 16-bit PIXEL ART, FULL BLEED - the land runs right to all four edges. ABSOLUTELY NO border, NO frame, NO panel edges, NO grid lines, NO dividing lines, NO margin, NO text, NO letters, NO numbers, NO labels anywhere. ONE single continuous connected continent filling the entire image, seen from above, with NINE neighbouring themed regions that blend seamlessly into one another with forests, hills and rivers between them - never separate tiles, never separate islands. In the CENTRE of EACH of the nine regions sits ONE clearly visible RECTANGULAR FOOTBALL PITCH with crisp white line markings and a small white GOAL at each end, and each pitch is made of that region's own material. A winding dirt road links all nine pitches in one snaking line. BOTTOM ROW, left to right: a PINK CANDY land of lollipops and gumdrops with a glossy pink candy pitch; a dark THUNDERSTORM ridge of black clouds and lightning with a wet dark slate pitch; a giant glass AQUARIUM dome of turquoise water and coral with a pale blue-green pitch inside it. MIDDLE ROW, right to left: a grey CRATER PLATEAU with a silver domed observatory, stars and a ringed planet, holding a dark metal space-station pitch; a red and gold CASINO town of card houses and giant dice with a deep red card-table pitch; a grey concrete SKATE PARK canyon of curved ramps and rails with a pale grey concrete pitch. TOP ROW, left to right: green JUNGLE RUINS of vine-covered stone temples with a mossy grey stone pitch; a golden SANDY SHORE on a bright blue lake with palm trees and a pale golden sand pitch; and in the TOP-RIGHT corner a majestic floodlit BLUE STADIUM holding a lush green striped GRASS pitch, with a huge GOLDEN TROPHY above it. Warm cohesive palette, crisp detailed pixel art, charming and epic. ${SCENE}` },
];
