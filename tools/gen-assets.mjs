...
const ASSETS = [
  ...
  { file: "roymap2.png",           size: 512, keyOut: false, prompt: `A beautiful hand-illustrated fantasy ADVENTURE MAP, richly detailed 16-bit PIXEL ART, full-bleed edge to edge, in the style of an old quest map or a pilgrim journey map - lush, colourful and charming with lots of little detail. A single clear winding road travels from a small seaside soccer village at the BOTTOM up to a majestic floodlit BLUE TURF STADIUM crowned with a GOLDEN TROPHY at the TOP. The road passes, in order from bottom to top, through distinct themed lands that all touch and flow into one another on ONE connected continent: a bright PINK CANDY land of lollipops, gumdrops and chocolate rivers, a dark THUNDERSTORM highland under black clouds and forked lightning, a great glass AQUARIUM dome full of turquoise water, coral and fish, a silver SPACE OBSERVATORY station on a crater plateau under stars with a ringed planet above, a red and gold CASINO town of card houses and giant dice, a grey concrete SKATE PARK canyon of curved ramps and rails, green JUNGLE RUINS of vine-covered stone temples, and a golden SANDY BEACH cove with palm trees and surf, before reaching the blue turf stadium at the summit. Rolling hills, forests, winding rivers and little soccer touches like goalposts and balls fill the space between the lands. Keep the winding road itself clear and open - no dots, no numbers, no flags, no text, no labels. Warm cohesive palette, crisp detailed pixel art, charming and epic. ${SCENE}` },
];
