...
const ASSETS = [
  ...
  { file: "icon-app.png",         size: 512, keyOut: false, prompt: `A square mobile app icon, chunky retro 16-bit PIXEL ART with large visible pixels and bold outlines. A black-and-white soccer ball flicked in motion with a bold curved banana-shot trail arcing behind it, a few bright ability sparks and little stars around it, colourful confetti, on a vibrant lime-green and dark arcade background; high contrast, energetic, reads clearly at tiny sizes; no text, no lettering, fills the whole square edge to edge.` },
