...
const ASSETS = [
  ...
  { file: "icon-volley.png",   size: 64,  prompt: `A single soccer player mid-air performing a powerful side volley, one leg swung out horizontally to strike a white ball, dynamic athletic kicking pose, bold thick chunky pixel silhouette, big and simple, centered, game power-up icon. ${ICON}` },
