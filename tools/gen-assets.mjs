...
const ASSETS = [
  ...
  { file: "icon-clearance.png",size: 64,  prompt: `A single soccer defender player figure in a blue kit sliding and stretching out one leg to boot a white-and-black soccer ball clear away from a small goal net behind them, a last-ditch defensive block/clearance, bold motion swoosh on the kicking leg, ABSOLUTELY NO text letters, ONLY the one sliding defender, the ball and the little net, thick dark outline, bold thick chunky pixel shapes, big and simple, centered, game power-up icon. ${ICON}` },
