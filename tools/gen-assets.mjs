...
const ASSETS = [
  ...
  { file: "icon-clearance.png",size: 64,  prompt: `A white-and-black soccer ball being booted clear away from a small goal net, a bold curved swoosh arrow showing the ball flying up and out to safety, a couple of impact spark lines where it was kicked, ABSOLUTELY NO person, no player, no body, no leg — ONLY the ball, the clearing swoosh arrow and the little goal net, thick dark outline, bold thick chunky pixel shapes, big and simple, centered, game power-up icon. ${ICON}` },
