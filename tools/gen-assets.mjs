...
const ASSETS = [
  ...
  { file: "icon-striker.png",  size: 64,  prompt: `Two bright glossy round game tokens overlapping like a duplicated stack (an extra player token): a vivid red disc with a bold white center stripe in front, and an identical copy peeking out behind and offset, flat top-down view, thick dark outline, bright high-contrast colors, bold simple chunky pixel art, big and easy to read, centered, game power-up icon. ${ICON}` },
