...
const ASSETS = [
  ...
  { file: "vsbg-argentina.png",   size: 320, keyOut: false, prompt: `Vertical full-bleed scene that fills the entire image edge to edge, no border, no frame, no vignette. The colourful Caminito street in La Boca, Buenos Aires on a bright day: rows of vivid red, blue and yellow corrugated-metal houses, a clear blue sky, warm sunlight, cheerful and vibrant, no text, no people. ${SCENE}` },
  ...
  { file: "vsbg-germany.png",      size: 320, keyOut: false, prompt: `Vertical full-bleed scene that fills the entire image edge to edge, no border, no frame, no vignette. Neuschwanstein castle in Bavaria on a bright clear day: a fairytale white castle on a green forested hill with snow-capped Alps behind, a blue sky with white clouds, vivid, no text, no people. ${SCENE}` },
  { file: "vsbg-england.png",      size: 320, keyOut: false, prompt: `Vertical full-bleed scene that fills the entire image edge to edge, no border, no frame, no vignette. London by day: Big Ben and the Houses of Parliament beside the river under a bright partly-cloudy sky, a red double-decker bus on the bridge, warm daylight, crisp and colourful, no text, no people. ${SCENE}` },
  ...
  { file: "vsbg-netherlands.png",  size: 320, keyOut: false, prompt: `Vertical full-bleed scene that fills the entire image edge to edge, no border, no frame, no vignette. Dutch tulip fields by day: rows of bright red, yellow and pink tulips leading to classic windmills beside a canal, a big blue sky with fluffy white clouds, cheerful and vivid, no text, no people. ${SCENE}` },
  { file: "vsbg-italy.png",        size: 320, keyOut: false, prompt: `Vertical full-bleed scene that fills the entire image edge to edge, no border, no frame, no vignette. The Roman Colosseum on a bright sunny day: warm honey-coloured stone under a clear blue sky, cypress trees and umbrella pines, vivid Mediterranean daylight, no text, no people. ${SCENE}` },
