...
const ASSETS = [
  ...
  { file: "icon-flex.png",     size: 64,  prompt: `A single bold flexed muscular arm showing a strong round bicep, cartoon strength symbol, warm skin tone with a bright highlight, thick dark outline, bold chunky pixel shapes, big and simple, centered, game icon. ${ICON}` },
