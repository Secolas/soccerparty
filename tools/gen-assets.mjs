...
const ASSETS = [
  ...
  { file: "vsbg-portugal.png",     size: 320, keyOut: false, prompt: `Portrait framing, Lisbon coast at dusk: dark silhouette of coastal cliffs and a tiled azulejo building with a vintage tram, a warm sunset over the Atlantic, lots of dark negative space, no text, no people. ${SCENE}` },
