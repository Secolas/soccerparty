...
const ASSETS = [
  ...
  { file: "vsbg-brazil.png",      size: 320, keyOut: false, prompt: `Portrait framing, Rio de Janeiro at dusk: dark silhouette of Sugarloaf Mountain and the Christ the Redeemer statue on a hill, a warm glowing sunset over the bay, palm fronds framing the edges, lots of dark negative space, no text, no people. ${SCENE}` },
  { file: "vsbg-argentina.png",   size: 320, keyOut: false, prompt: `Portrait framing, Buenos Aires La Boca at night: dark rows of colourful corrugated-metal houses with warm glowing windows, a faint tango streetlamp glow, deep blue sky, lots of dark negative space, no text, no people. ${SCENE}` },
  ...
  { file: "vsbg-spain.png",        size: 320, keyOut: false, prompt: `Portrait framing, a Spanish evening plaza: dark silhouette of a grand cathedral and terracotta rooftops, a warm golden sunset, strings of hanging festival lights, lots of dark negative space, no text, no people. ${SCENE}` },
  { file: "vsbg-germany.png",      size: 320, keyOut: false, prompt: `Portrait framing, Bavaria at night: dark silhouette of a fairytale hilltop castle backed by pine forest, a cool moonlit sky, faint town lights below, lots of dark negative space, no text, no people. ${SCENE}` },
  { file: "vsbg-england.png",      size: 320, keyOut: false, prompt: `Portrait framing, London at night: dark silhouette of Big Ben and the Houses of Parliament by the river, warm lamplight reflections, deep blue sky, lots of dark negative space, no text, no people. ${SCENE}` },
  { file: "vsbg-portugal.png",     size: 320, keyOut: false, prompt: `Vertical full-bleed scene that fills the entire image edge to edge, absolutely no border, no decorative frame, no vignette, no letterboxing. Lisbon coast at dusk: dark silhouette of coastal cliffs and a hillside of tiled houses with a vintage tram, a warm sunset over the Atlantic, lots of dark negative space, no text, no people. ${SCENE}` },
  { file: "vsbg-netherlands.png",  size: 320, keyOut: false, prompt: `Portrait framing, Dutch countryside at dusk: dark windmill silhouettes beside a canal, rows of tulips catching low warm light, a big moody sky, lots of dark negative space, no text, no people. ${SCENE}` },
  { file: "vsbg-italy.png",        size: 320, keyOut: false, prompt: `Portrait framing, Rome at night: dark silhouette of the Colosseum lit with warm amber uplighting, a deep starry sky, lots of dark negative space, no text, no people. ${SCENE}` },
  { file: "vsbg-belgium.png",      size: 320, keyOut: false, prompt: `Portrait framing, the Brussels Grand-Place at night: dark ornate guild-hall silhouettes with warm golden window glow, a faint misty square, lots of dark negative space, no text, no people. ${SCENE}` },
  ...
  { file: "vsbg-senegal.png",      size: 320, keyOut: false, prompt: `Vertical full-bleed scene that fills the entire image edge to edge, absolutely no border, no decorative frame, no vignette, no letterboxing. The Senegal savanna at dusk: dark silhouettes of flat-topped acacia trees and a lone baobab on the open plains, a giraffe silhouette, a big warm orange sun low on the horizon, lots of dark negative space, no text, no people. ${SCENE}` },
];
