...
const ASSETS = [
  ...
  { file: "icon-flick.png",    size: 64,  prompt: `A single chunky soccer cleat boot in side view, no ball, just the boot, very bold thick simple silhouette, minimal detail, high contrast, fills most of the frame, game icon. ${ICON}` },
