...
const ASSETS = [
  ...
  { file: "icon-press.png",    size: 64,  prompt: `A single aggressive soccer defender player figure in a red kit sprinting and lunging toward a small white-and-black soccer ball just ahead of their feet, bold forward motion swoosh lines behind them showing a hard chase, a high-pressing closing-down vibe, ABSOLUTELY NO text letters, ONLY the one chasing player and the ball, thick dark outline, bold thick chunky pixel shapes, big and simple, centered, game power-up icon. ${ICON}` },
