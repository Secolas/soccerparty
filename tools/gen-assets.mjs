...
const ASSETS = [
  ...
  { file: "icon-topspin.png",  size: 64,  prompt: `A single white-and-black soccer ball with a bold bright curved spin arrow looping over the top of it to show heavy forward topspin, plus a couple of short motion lines behind it, the ball floats alone directly on the flat solid magenta background with plenty of magenta all around it, NO card, NO frame, NO panel behind it, ABSOLUTELY NO person and no text letters, ONLY the ball and its spin arrow, thick dark outline, bold thick chunky pixel shapes, big and simple, centered, game power-up icon. ${ICON}` },
  ...
  { file: "icon-momentum.png", size: 64,  prompt: `A single white-and-black soccer ball riding up a bold bright green rising arrow that climbs steeply to the upper right like a surging momentum graph, a couple of small speed lines and spark accents behind the ball to show building power, floats on the flat solid magenta background with magenta all around, NO card, NO frame, NO panel behind it, ABSOLUTELY NO person and no text letters, ONLY the ball and the rising arrow, thick dark outline, bold thick chunky pixel shapes, big and simple, centered, game power-up icon. ${ICON}` },
