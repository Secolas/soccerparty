...
const ASSETS = [
  ...
  { file: "roymap2.png",           size: 512, keyOut: false, prompt: `A beautiful hand-illustrated fantasy ADVENTURE MAP of a tropical ARCHIPELAGO, richly detailed 16-bit PIXEL ART, full-bleed edge to edge, deep blue-teal OCEAN everywhere. Exactly NINE islands, each holding ONE soccer pitch, laid out in a STRICT EVENLY SPACED 3x3 GRID of three rows and three columns with wide open sea between them, every island the same size and clearly separated. BOTTOM ROW, left to right: a bright PINK CANDY island of lollipops and gumballs; a dark THUNDERSTORM island under black clouds and lightning bolts; a turquoise CORAL REEF lagoon island with bubbles and tropical fish. MIDDLE ROW, left to right: a metallic SPACE STATION island of silver domes under stars with a ringed planet above it; a red and gold CASINO island with playing cards, dice and chips; a grey concrete SKATE PARK island with curved ramps and rails. TOP ROW, left to right: a green JUNGLE RUINS island with vines and a stone temple; a golden SANDY BEACH island with palm trees and surf; and in the TOP-RIGHT corner a grand floodlit blue TURF STADIUM island crowned with a large GOLDEN TROPHY. Little boats, waves and seabirds dot the ocean. NO route lines, NO dotted paths, NO numbers, NO flags, NO text, NO labels anywhere. Warm cohesive palette, crisp detailed pixel art, charming and epic. ${SCENE}` },
];
